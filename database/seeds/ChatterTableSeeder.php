...
class ChatterTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!\DB::table('users')->find(1)) {
            ...
            \DB::table('users')->insert([
                0 => [
                    'name'           => 'Francisco Lasso',
                    'email'          => 'mcastillo@projectadmin.com',
                    'rol_id'         => 1,
                    'avatar'         => '',
                    'password'       => Hash::make('Paramore1988'),
                    'remember_token' => 'FvlORzs8dyG8IYqssJGcuOY2F0vnjBy2PnHHTX2MoV7Hh6udjJd6hcTox3un',
                    'created_at'     => '2016-07-29 15:13:02',
                    'updated_at'     => '2016-08-18 14:33:50',
                ],
            ]);
            ...
            \DB::table('users')->insert([
                0 => [
                    ...
                    'email'          => 'mcastillo@hometherapy.com',
                    'rol_id'         => 2,
                    'avatar'         => '',
                    'password'       => Hash::make('Paramore1988'),
                    'remember_token' => 'FvlORzs8dyG8IYqssJGcuOY2F0vnjBy2PnHHTX2MoV7Hh6udjJd6hcTox3un',
            ...
            \DB::table('users')->insert([
                0 => [
                    ...
                    'email'          => 'nicolas.arevalo@projectadmin.com',
                    'rol_id'         => 1,
                    'avatar'         => '',
                    'password'       => Hash::make('Nicolas123456'),
                    'remember_token' => 'FvlORzs8dyG8IYqssJGcuOY2F0vnjBy2PnHHTX2MoV7Hh6udjJd6hcTox3un',
                    'created_at'     => '2016-07-29 15:13:02',
                    'updated_at'     => '2016-08-18 14:33:50',
                ],
